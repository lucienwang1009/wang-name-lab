  ...
  return (
    <section className="page-section">
      ...
      <div className="method-intro">
        ...
        <div>
          <h2>宽进、分级、窄出，再让每次反馈改变下一次推荐</h2>
          <p>
            70 部古籍先广泛发现字词，再分成“人工精审、规则粗筛、仅检索”三层。前两层可进入持续推荐，但规则粗筛始终标明待人工复核，不冒充精选结论。
          </p>
        </div>
      </div>
      ...
      <div className="method-grid">
        ...
        <article>
          <span>03</span>
          <h3>个人适配</h3>
          <p>不设前置问卷。每看一个名字就记录一次直觉：很喜欢为强正信号，还不错为弱正信号，不喜欢为强负信号，跳过为中性信号。</p>
          <p>反馈既影响这个名字，也会按古典感、端雅、清峻、少见度、易用性和家族意义等特征，小步调整相似候选；撤销会反向还原这次学习。</p>
          <p>解释只说“为什么适合你们”，不把个人适配冒充名字的客观总分。</p>
        </article>

        <article>
          <span>04</span>
          <h3>连续推荐与多样性</h3>
          <p>系统每次只给一个名字。每五次推荐中，三次贴近当前偏好、一次主动拓宽、一次探索尚不确定的方向，即 60% 利用、20% 多样、20% 探索。</p>
          <p>适配与拓宽推荐使用 MMR：0.75 × 个人适配 + 0.25 × 与最近六个已看名字的差异；探索推荐综合偏好不确定性 50%、最近差异 30% 和个人适配 20%。</p>
          <p>候选相似度由风格 45%、共享字 20%、同音 15%、同典籍 10%、同取字关系 10% 构成；“最近差异”取 1 减去与近期名字的最高相似度。规则粗筛尚未复核读音时不加同音判定。</p>
          <p>当前策略、适配、差异、MMR、探索值和曝光惩罚均在名字卡上公开。</p>
        </article>
